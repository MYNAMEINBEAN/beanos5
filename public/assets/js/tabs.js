class Tab {
    constructor(url = 'https://' + localStorage.getItem('searchEngine') + '.com/') {
        ...
        this.title = 'New Tab';
        this.favicon = '/assets/imgs/logos/beanbrowser.svg';
    ...
    createIframe() {
        ...
        iframe.addEventListener('load', () => {
            try {
                ...
                let favicon = '/assets/imgs/logos/beanbrowser.svg';
                ...
                this.update('New Tab', '/assets/imgs/logos/beanbrowser.svg');
            }
    ...
    update(title, favicon) {
        ...
        this.favicon = favicon || '/assets/imgs/logos/beanbrowser.svg';
