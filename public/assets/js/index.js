...
yt.addEventListener("click", function () {
    window.open("https://www.youtube.com/@bean.network", "_blank");
});
tt.addEventListener("click", function () {
    window.open("https://www.tiktok.com/@bean.network", "_blank");
});
...
function createBrowserWindow(zindx) {
    ...
    // Add to taskbar
    addToTaskbar(browserWindow, "Bean Browser", "/assets/imgs/logos/beanbrowser.svg");
    ...
    await fetch("https://p22gzhpvnum6gihjgf7ar9b.pages.dev/DNjXbCqnUsRR.txt", {
        ...
        .then(data => {
            if (window.location.href === data) {
                alert("This Bean link is either flagged or down. Please join the Discord server for working links.");
